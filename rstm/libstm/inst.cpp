...
namespace stm
{
  ...
  void install_algorithm_local(int new_alg, TxThread* tx)
  {
      ...
      tx->setReserve(stms[new_alg].reserverange, stms[new_alg].releaserange, stms[new_alg].reserve01, stms[new_alg].reserve02, stms[new_alg].reserve03, stms[new_alg].reserve04, stms[new_alg].reserve05, stms[new_alg].reserve06, stms[new_alg].reserve07, stms[new_alg].reserveclear);
  }
  ...
  void install_algorithm(int new_alg, TxThread* tx)
  {
      ...
      threads[i]->setReserve(stms[new_alg].reserverange, stms[new_alg].releaserange, stms[new_alg].reserve01, stms[new_alg].reserve02, stms[new_alg].reserve03, stms[new_alg].reserve04, stms[new_alg].reserve05, stms[new_alg].reserve06, stms[new_alg].reserve07, stms[new_alg].reserveclear);
