...
namespace stm
{
  ...
  struct alg_t
  {
      ...
      int  (*TM_FASTCALL reserve04)(TxThread* tx, int bitmask, uintptr_t addr0, uintptr_t addr1, uintptr_t addr2, uintptr_t addr3, int instrs, int reads, int writes);
      int  (*TM_FASTCALL reserve05)(TxThread* tx, int bitmask, uintptr_t addr0, uintptr_t addr1, uintptr_t addr2, uintptr_t addr3, uintptr_t addr4, int instrs, int reads, int writes);
      int  (*TM_FASTCALL reserve06)(TxThread* tx, int bitmask, uintptr_t addr0, uintptr_t addr1, uintptr_t addr2, uintptr_t addr3, uintptr_t addr4, uintptr_t addr5, int instrs, int reads, int writes);
      int  (*TM_FASTCALL reserve07)(TxThread* tx, int bitmask, uintptr_t addr0, uintptr_t addr1, uintptr_t addr2, uintptr_t addr3, uintptr_t addr4, uintptr_t addr5, uintptr_t addr6, int instrs, int reads, int writes);
      int  (*TM_FASTCALL reserveclear)(TxThread* tx);
